 ...
 * @author daner
 */
public class Cerificado_de_Asistencia_Asistente extends javax.swing.JFrame {

    /**
     * Creates new form Cerificado_de_Asistencia
     */
    private final ArrayList<Asistente> List;
    public Cerificado_de_Asistencia_Asistente() {
        List = new ArrayList<>();
        initComponents();
...
Matriz,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cerificado_de_Asistencia_Asistente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cerificado_de_Asistencia_Asistente().setVisible(true);
            }
        });
    }
